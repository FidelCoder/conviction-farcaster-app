...
export function GoogleWalletMark({ className = "" }: WalletMarkProps) {
  return (
    <span className={"wallet-brand-mark wallet-brand-mark-google " + className} aria-label="Google" role="img">
      <svg viewBox="0 0 48 48" aria-hidden="true" focusable="false">
        ...
        <path fill="#4CAF50" d="M24 44c5.17 0 9.86-1.98 13.41-5.2l-6.19-5.24C29.21 35.09 26.7 36 24 36c-5.2 0-9.61-3.31-11.28-7.93l-6.52 5.03C9.51 39.56 16.23 44 24 44Z" />
        <path fill="#1976D2" d="M43.61 20.08H42V20H24v8h11.3a12.05 12.05 0 0 1-4.08 5.56l6.19 5.24C36.97 39.2 44 34 44 24c0-1.34-.14-2.65-.39-3.92Z" />
      </svg>
    </span>
  );
}
...
export function BrowserWalletMarks({ className = "" }: WalletMarkProps) {
  return (
    <span className={"wallet-brand-cluster " + className} aria-label="MetaMask, Coinbase, Trust Wallet and more" role="img">
      ...
      <span className="wallet-brand-chip wallet-brand-chip-trust">
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path d="M12 3 19 6v5.4c0 4.45-2.76 8.44-7 9.6-4.24-1.16-7-5.15-7-9.6V6l7-3Z" fill="currentColor" />
        </svg>
      </span>
